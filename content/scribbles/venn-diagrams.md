...
To do so, you need to know how far apart the circles should be. It turns out this distance doesn't have a closed form solution, but you can define a function from distance &#8594; overlap and then find it via binary search.
